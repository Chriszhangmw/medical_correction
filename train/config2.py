...
class Config:
    ...
    BERT_CONFIG_PATH = "./pre_models/chinese_L-12_H-768_A-12/bert_config.json"
    BERT_CHECKPOINT_PATH = "./pre_models/chinese_L-12_H-768_A-12/bert_model.ckpt"
    BERT_VOCAB_PATH = "./pre_models/chinese_L-12_H-768_A-12/vocab.txt"
